...
class DocReader implements DocReaderInterface
{
     ...
     * @param \ReflectionClass        $declaringClass
     *
     * @return ReflectionTypeInterface|ArrayType|ClassType|CompositeType
     *
     * @throws ClassNotFoundException
     * @throws \kuiper\reflection\exception\FileNotFoundException
     * @throws \kuiper\reflection\exception\SyntaxErrorException
     */
